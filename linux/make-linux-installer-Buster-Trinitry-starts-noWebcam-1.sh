...
cp -d "$sourcePathLib"libQt5Core.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Gui.so* $targetPathLib
cp -d "$sourcePathLib"libQt5MultimediaGstTools.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Multimedia.so* $targetPathLib
cp -d "$sourcePathLib"libQt5MultimediaWidgets.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Network.so* $targetPathLib
cp -d "$sourcePathLib"libQt5OpenGL.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Svg.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Widgets.so* $targetPathLib
cp -d "$sourcePathLib"libQt5X11Extras.so* $targetPathLib
cp -d "$sourcePathLib"libQt5XcbQpa.so* $targetPathLib
cp -d "$sourcePathLib"libQt5DBus.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Quick.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Qml.so* $targetPathLib
cp -d "$sourcePathLib"libQt5Xml.so* $targetPathLib
cp -d "$sourcePathLib"libQt5TextToSpeech.so* $targetPathLib
...
# vokoscreenNG benötigt folgende libs
...
cp -d /lib64/libgcc_s.so*                               $targetPathLib
cp -d /lib64/libc.so*                                   $targetPathLib
cp -d /usr/lib64/libgmodule-2.0.so*                     $targetPathLib
cp -d /usr/lib64/libunwind.so*                          $targetPathLib
cp -d /lib64/libm.so*                                   $targetPathLib
cp -d /lib64/librt.so*                                  $targetPathLib
cp -d /lib64/libdl.so*                                  $targetPathLib
cp -d /lib64/libpthread.so*                             $targetPathLib
...
cp -d /usr/lib64/libpulse-mainloop-glib.so*             $targetPathLib
cp -d /usr/lib64/libpulse.so*                           $targetPathLib
cp -d /lib64/libz.so*                                   $targetPathLib
...
cp -d /lib64/libselinux.so*                             $targetPathLib
...
cp -d /lib64/ld-linux-x86-64.so*                        $targetPathLib

# libgstbasecamerabinsrc-1.0.so.0 benötigt folgende libs
