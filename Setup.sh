...
# Begin copy libs vokoscreen
#echo "Begin copy libs vokoscreen"
#ldd ./packages/root/data/vokoscreen | grep "/usr/" | sed 's/^[ \t]*//' | cut -d" " -f3 > libs.txt
...
#rm libs.txt
#echo "End copy libs vokoscreen"
# End copy libs vokoscreen


prefix_Qt="/home/vk/Qt5.9.1/5.9.1/gcc_64/lib/"
# Option -d kopiert Softlinks
cp -d $prefix_Qt*".so."* ./packages/root/data/lib

prefix_Plugins="/home/vk/Qt5.9.1/5.9.1/gcc_64/plugins/"
